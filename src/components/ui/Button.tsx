...
const variantStyles: Record<Variant, string> = {
  primary:
    "bg-eco-600 text-white hover:bg-eco-700 focus:ring-eco-500",
  secondary:
    "bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 focus:ring-eco-500",
  danger:
    "bg-red-600 text-white hover:bg-red-700 focus:ring-red-500",
  ghost:
    "text-gray-600 hover:text-gray-900 hover:bg-gray-100 focus:ring-eco-500",
};
